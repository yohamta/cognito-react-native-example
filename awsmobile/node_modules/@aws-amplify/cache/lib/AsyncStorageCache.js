            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, (spaceItemNeed > cacheThresholdSpace) ? spaceItemNeed : cacheThresholdSpace];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        key = keyInCache[i];
                        if (!(key.indexOf(this.config.keyPrefix) === 0 && key !== this.cacheCurSizeKey)) return [3 /*break*/, 6];
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        cacheItemOptions = {
                            ...
                            expires: options && options.expires !== undefined ? options.expires : (this.config.defaultTTL + CacheUtils_1.getCurrTime())
                        };
